var BilibiliLiveHimeBackground = (function () {
	...
	function () {
	  function Background() {
	        ...
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              ...
	              _context.t0 = type;
	              _context.next = _context.t0 === START ? 4 : _context.t0 === STOP ? 8 : _context.t0 === DANMU_ERROR ? 11 : _context.t0 === DANMU_OPTION ? 17 : 29;
	              break;

	            case 4:
	              _this.config = _objectSpread({}, Background.Config, {}, data);
	              _context.next = 7;
	              return regenerator.awrap(_this.start());
	            ...
	            case 8:
	              _context.next = 10;
	              return regenerator.awrap(_this.stop());
	            ...
	            case 11:
	              ...
	              _context.next = 14;
	              return regenerator.awrap(removeTab(_this.config.liveTab));
	            ...
	            case 17:
	              ...
	              _context.next = 23;
	              return regenerator.awrap(setStorage(DANMU_OPTION, request));

	            case 23:
	              sendMessageToTab(activeTab, request);
	              _context.next = 26;
	              return regenerator.awrap(removeTab(liveTab));
	    ...
	    storageChange(function _callee2(changes) {
	        ...
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            case 0:
	              ...
	              _context2.next = 4;
	              return regenerator.awrap(setBadge('ON'));
	            ...
	            case 6:
	              _context2.next = 8;
	              return regenerator.awrap(setBadge(''));
	  ...
	  createClass(Background, [{
	    key: "connectSocket",
	    value: function connectSocket(url) {
	      return new Promise(function (revolve, reject) {
	        var socket = socket_io(url);
	    ...
	    key: "tabCapture",
	    value: function tabCapture(res) {
	      return new Promise(function (revolve, reject) {
	        var captureOptions = Background.CaptureOptions;
	        var resolution = Background.Resolution[res];
	    ...
	    key: "recorder",
	    value: function recorder(stream, videoBitsPerSecond) {
	      return new Promise(function (revolve, reject) {
	        var recorderOptions = Background.RecorderOptions;
	        ...
	        while (1) {
	          switch (_context6.prev = _context6.next) {
	            ...
	            case 13:
	                ...
	                return regenerator.async(function _callee3$(_context3) {
	                  while (1) {
	                    switch (_context3.prev = _context3.next) {
	                      case 0:
	                        _context3.next = 2;
	                        return regenerator.awrap(debug.log(info));
	              ...
	              this.socket.on(RECONNECT, function _callee4(info) {
	                var recording1, recording2;
	                return regenerator.async(function _callee4$(_context4) {
	                  while (1) {
	                    switch (_context4.prev = _context4.next) {
	                      case 0:
	                        _context4.next = 2;
	                        return regenerator.awrap(debug.err(info));
	                      ...
	                      case 4:
	                        recording1 = _context4.sent;

	                        if (!(_this2.reconnect >= RECONNECT_TIME || !recording1)) {
	                          _context4.next = 10;
	                          break;
	                        }
	                      ...
	                      case 10:
	                        _this2.reconnect += 1;
	                        _context4.next = 13;
	                        return regenerator.awrap(debug.log(RECONNECT_INFO + _this2.reconnect));
	              ...
	              this.socket.on(FAIL, function _callee5(info) {
	                return regenerator.async(function _callee5$(_context5) {
	                  while (1) {
	            ...
	            case 47:
	              this.mediaRecorder.ondataavailable = function (event) {
	                if (event.data && event.data.size > 0) {
	                  // 告知服务器命令：推流
	                  _this2.socket.emit(BINARY_STREAM, event.data, rtmp);
	                }
	              };
	      ...
	      return regenerator.async(function stop$(_context7) {
	        while (1) {
	          switch (_context7.prev = _context7.next) {
	            ...
	            case 4:
	              _context7.next = 6;
	              return regenerator.awrap(setStorage(DANMU_OPTION, false));
